    ...
    >
      ...
      <Reveal immediate delay={200}>
        ...
        >
          ...
          <div className="w-full rounded-lg overflow-hidden mt-2">
            <img
              src="https://static.wixstatic.com/media/bb108e_c9b4a8c342834d6bb7a1aa804e28daf4~mv2.jpg"
      ...
      <Reveal delay={100}>
        ...
        >
          ...
          <GapCard
            title="Adoption and engagement metrics"
            description="Add post-launch numbers here: list creation rate, repeat order rate via lists, session time reduction. These will make the outcome concrete."
          />
        </section>
      </Reveal>
      ...
      <Reveal delay={100}>
        ...
        >
          ...
          <GapCard
            ...
            description="Who else was involved? PM, engineers, data team? Clarify what was owned vs shared, especially decisions around the smart model and substitutions scope."
          />
        </section>
      </Reveal>
      ...
      <Reveal delay={100}>
        ...
        >
          ...
          <p className="type-body max-w-[640px]">
            ...
            <em>Competing Against Luck</em>, 2016) helped clarify what was
            actually happening here. Customers don't hire maX to "place
            orders". They hire it to get materials sorted so they can get back
            on the tools. Searching was not part of the job they were trying to
            do. It was friction blocking it.
          </p>
      ...
      <Reveal delay={100}>
        ...
        >
          ...
          <p className="type-body max-w-[640px]">
            Interview and test questions were designed following the principles
            in Caroline Jarrett's{" "}
            <em>Surveys That Work</em> (2021), keeping each question
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              { stat: "3 BUs", label: "covered in guerilla research" },
              { stat: "2 states", label: "research reach" },
            ...
            {[
              {
                ...
                detail:
                  "A plumber isn't placing an order for compression fittings. They're trying to finish a bathroom before Friday. Every extra tap on maX is time not spent on the thing that actually pays them. The research confirmed it: ordering was seen as a necessary interruption, not a workflow.",
              },
              {
                number: "02",
                finding: "Repeat behaviour was invisible to the system.",
                detail:
                  "The same dozen products showed up across dozens of orders for the same customer. maX had the data and wasn't using it. Customers were solving this problem themselves, with notes apps, screenshots, and memory. The platform was leaving that job entirely to them.",
              },
              {
                number: "03",
                finding:
                ...
                detail:
                  "Post-launch usage data surfaced this one. Customers create a list and rarely touch it again. If a product gets discontinued, they still try to reorder it. The feature saving them time was quietly generating a new class of order failure at the branch.",
              },
            ].map((item) => (
      ...
      <Reveal delay={100}>
        ...
        >
          ...
          <p className="type-body max-w-[640px]">
            The whole design leaned on Nielsen's recognition-over-recall
            heuristic (Heuristic 6, 1994). Instead of making customers recall
            product codes and search strings from memory, saved lists let them
            recognise what they need and add it in one tap. Cognitive load
            drops. Order completion rate goes up.
          </p>
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <p className="type-body max-w-[640px]">
              ...
              history, named by job type or brand or whatever taxonomy makes
              ...
              Different contexts, different feature surfaces, same underlying
              data.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
            <div className="flex flex-col gap-2">
              <p className="type-meta opacity-40">Mobile</p>
              <div className="w-full rounded-lg overflow-hidden">
                <img
                  src="https://static.wixstatic.com/media/bb108e_3d4e6f62001b4084a24074ccd0693729~mv2.png"
                  alt="Product Lists on mobile - list view"
                  className="w-full h-auto"
                />
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <p className="type-meta opacity-40">Web</p>
              <div className="w-full rounded-lg overflow-hidden">
                <img
                  src="https://static.wixstatic.com/media/bb108e_bfc2c91be28c4e9c93a1b832debbbeac~mv2.png"
                  alt="Product Lists on web - admin view"
                  className="w-full h-auto"
                />
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <p className="type-body max-w-[640px]">
              ...
              the app. This is progressive disclosure (Tog, AskTog): surface
              the right information at the right moment in the flow, not all at
              once on a settings page nobody visits.
            </p>
          </div>
